                    ...
                    <table id="datatable1" class="table display responsive nowrap">
                        ...
                        <tbody class="text-center">
                            ...
                            <tr>
                                ...
                                <td><p>{{ isset($brandData->categoryfuncB) ? $brandData->categoryfuncB->category_name_en: '-'}}</p></td>
                                <td><p>{{ isset($brandData->subcategoryfuncB) ? $brandData->subcategoryfuncB->subcategory_name_en: '-'}}</p></td>
                                <td> {{ $brandData->brand_name_en }} </td>
                                <td> {{ $brandData->brand_name_bn }} </td>
                                <td>
                                    <a href=" {{ url('admin/brand-edit/'. $brandData->brand_id) }} " class="btn btn-primary" title="Edit"><i class="tx-18 fa fa-pencil-square-o"></i></a>
                                    <a href=" {{ url('admin/brand-delete/'. $brandData->brand_id) }} " class="btn btn-danger" title="Delete" id="delete"><i class="tx-18 fa fa-trash"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
            ...
            <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
                ...
                <form action=" {{ route('brand-add') }} " method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mg-t-20 form-group  {{ $errors->has('subcategory_id') ? ' has-error' : '' }}">
                        {{-- Select option with search facility  --}}
                        <label class="col-sm-4 form-control-label">Select Sub Category: <span class="tx-danger">*</span></label>
                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
