                    ...
                    <table id="datatable1" class="table display responsive nowrap table-primary mg-b-0">
                        ...
                        <tbody class="text-center">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href=" {{ url('admin/coupon-edit/'.$division->division_id  ) }} " class="btn btn-primary" title="Edit"><i class="tx-18 fa fa-pencil-square-o"></i></a>
                                    <a href=" {{ url('admin/coupon-delete/'.$division->division_id  ) }} " class="btn btn-danger" title="Delete" id="delete"><i class="tx-18 fa fa-trash"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
