                                ...
                                @foreach ($categories as $category)
                                    <div class="accordion-group">
                                        <div class="accordion-heading">
                                            @if (Session()->get('language') == 'bangla')
                                                <a href="#{{ $category->category_id }}" data-toggle="collapse" class="accordion-toggle collapsed"> {{ $category->category_name_bn }} </a>
                                            @else
                                                <a href="#{{ $category->category_id }}" data-toggle="collapse" class="accordion-toggle collapsed"> {{ $category->category_name_en }} </a>
                                            @endif
                                        </div><!-- /.accordion-heading -->
                                        @php
                                             $subcategories = App\Models\Subcategory::where('category_id',$category->category_id)->orderBy('subcategory_name_en','ASC')->get();
                                        @endphp
                                        <div class="accordion-body collapse" id="{{ $category->category_id }}" style="height: 0px;">
                                            <div class="accordion-inner">
                                                <ul>
                                                    @foreach ($subcategories as $subcategory)
                                                        @if (Session()->get('language') == 'bangla')
                                                        <li><a href="#{{ $category->category_id }}" data-toggle="collapse" class="accordion-toggle collapsed"> {{ $subcategory->subcategory_name_bn }} </a></li>
                                                        @else
                                                        <li><a href="#{{ $category->category_id }}" data-toggle="collapse" class="accordion-toggle collapsed"> {{ $subcategory->subcategory_name_en }} </a></li>
                                                        @endif
                                                    @endforeach
                                                </ul>
                                            </div><!-- /.accordion-inner -->
