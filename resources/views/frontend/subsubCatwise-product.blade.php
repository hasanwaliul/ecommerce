        ...
        <div class="breadcrumb-inner">
            @if (Session()->get('language') == 'bangla')
                <ul class="list-inline list-unstyled">
                    <li><a href="#">হোম</a></li>
                    <li class='active'>সাব ক্যাটাগরী অনুযায়ী দ্রব্যসমুহ</li>
                </ul>
            @else
                <ul class="list-inline list-unstyled">
                    <li><a href="#">Home</a></li>
    ...
    <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
        ...
        <div class="clearfix filters-container m-t-10">
            <div class="row">
                ...
                <div class="col col-sm-6 col-md-4">
                    <div class="filter-tabs">
                        <ul id="filter-tabs" class="nav nav-tabs nav-tab-box nav-tab-fa-icon">
                            <li class="active">
                                @if (Session()->get('language') == 'bangla')
                                <a data-toggle="tab" href="#grid-container"><i class="icon fa fa-th-large"></i>ব্লক
                                    ভিউ</a>
                                @else
                                <a data-toggle="tab" href="#grid-container"><i class="icon fa fa-th-large"></i>Grid
                                    view</a>
                                @endif
                            </li>
                            <li>
                                @if (Session()->get('language') == 'bangla')
                                <a data-toggle="tab" href="#list-container"><i class="icon fa fa-th-list"></i>লিস্ট
                                    ভিউ</a>
                                @else
                ...
                {{-- Product view and show part start --}}
                ...
                {{-- Product view and show part end --}}
                                ...
                                <div class="products">
                                    ...
                                    <div class="product">
                                        <div class="product-image">
                                            ...
                                            @else
                                            <div class="tag sale">
                                                <span> @if (Session()->get('language') == 'bangla') {{
                                        ...
                                        <div class="product-info text-left">
                                            ...
                                            <div class="product-price">
                                                ...
                                                <span class="price">
                                                    @if (Session()->get('language') == 'bangla') {{
                                                    bn_price($product->actual_price) }} @else {{
                                                    $product->actual_price}} @endif
                                                </span>
                                                @else
                                                <span class="price">
                                                    @if (Session()->get('language') == 'bangla') {{
                                                    bn_price($product->discount_price) }} @else {{
                                                ...
                                                <ul class="list-unstyled">
                                                    <li class="add-cart-button btn-group">
                                                        ...
                                                        <button class="btn btn-primary cart-btn" type="button">
                                                            @if (Session()->get('language') == 'bangla') ব্যাগে যুক্ত
                                                            করুন @else Add to cart @endif
                                                        </button>
                                                    </li>
                        ...
                        <div class="category-product-inner wow fadeInUp">
                            <div class="products">
                                <div class="product-list product">
                                                    ...
                                                    <div class="action">
                                                        <ul class="list-unstyled">
                                                            <li class="add-cart-button btn-group">
                                                                ...
                                                                <button class="btn btn-primary cart-btn" type="button">
                                                                    @if (Session()->get('language') == 'bangla') ব্যাগে
                                                                    যুক্ত করুন @else Add to cart @endif
                                                                </button>
                                                            </li>
                                    ...
                                    <div class="tag sale">
                                        <span> @if (Session()->get('language') == 'bangla') {{
                                            bn_price(round($discount)) }}% @else {{ round($discount) }}% @endif </span>
                                    </div>
                                    @endif
                                </div><!-- /.product-list -->
                            </div><!-- /.products -->
